...
/* Only first image of each page uploaded so far — expand when more are added */
const IMAGES = [
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="s6-card s6-desktop">
          <div className="s6-gallery">
            ...
            >
              {IMAGES.map((src, i) => (
                <div className="s6-page s6-page-desktop" key={i}>
                  <div className="s6-imgbox">
        ...
        <div className="s6-card s6-mobile">
          <div className="s6-gallery">
            ...
            >
              {IMAGES.map((src, i) => (
                <div className="s6-page s6-page-mobile" key={i}>
                  <div className="s6-imgbox">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={src} alt={`project-${i + 1}`} loading="lazy" />
                  </div>
