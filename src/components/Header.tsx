    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="#" aria-label="Instagram" className="hover:!text-[#919191] transition-colors" style={{ color: "#1f1f1f" }}>
          ...
          <a href="#" aria-label="X" className="hover:!text-[#919191] transition-colors" style={{ color: "#1f1f1f" }}>
          ...
          <a href="#" aria-label="LinkedIn" className="hover:!text-[#919191] transition-colors" style={{ color: "#1f1f1f" }}>
