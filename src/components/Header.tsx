    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <span>Follow us:</span>
          <a href="#" aria-label="Facebook" className="text-[#1f1f1f] hover:text-[#919191] transition-colors">
          ...
          <a href="#" aria-label="Instagram" className="text-[#1f1f1f] hover:text-[#919191] transition-colors">
            <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="5"/><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" stroke="none"/></svg>
          </a>
          <a href="#" aria-label="X" className="text-[#1f1f1f] hover:text-[#919191] transition-colors">
          ...
          <a href="#" aria-label="LinkedIn" className="text-[#1f1f1f] hover:text-[#919191] transition-colors">
