              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "50px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: "30px", alignItems: "center" }}>
                    <a href="https://www.facebook.com/p/Biostate-AI-61562900021094/" target="_blank" rel="noopener noreferrer" style={{ color: "#ffffff", display: "flex" }}>
                    ...
                    <a href="https://www.instagram.com/biostate.ai" target="_blank" rel="noopener noreferrer" style={{ color: "#ffffff", display: "flex" }}>
                    ...
                    <a href="https://www.linkedin.com/company/biostate-ai/" target="_blank" rel="noopener noreferrer" style={{ color: "#ffffff", display: "flex" }}>
                    ...
                    <a href="https://x.com/biostateai" target="_blank" rel="noopener noreferrer" style={{ color: "#ffffff", display: "flex" }}>
