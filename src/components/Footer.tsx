              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "80px" }}>
                  ...
                  <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
                    <a href="https://www.facebook.com/p/Biostate-AI-61562900021094/" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.8)", display: "flex" }}>
                    ...
                    <a href="https://www.instagram.com/biostate.ai" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.8)", display: "flex" }}>
                    ...
                    <a href="https://www.linkedin.com/company/biostate-ai/" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.8)", display: "flex" }}>
                    ...
                    <a href="https://x.com/biostateai" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.8)", display: "flex" }}>
