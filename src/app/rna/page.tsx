          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                ...
                <ul style={{ paddingTop: "32px", fontSize: "16px", color: "#333", fontWeight: 500, lineHeight: "1.875em", display: "flex", flexDirection: "column", gap: "12px", listStyle: "none" }}>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> Cultured animal cells with &gt;30,000 cells</li>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> Extracted RNA from Mammalian samples</li>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> {"The Conc. ≥ 16 ng/μL (min 10 μl)"}</li>
                </ul>
              </div>
            ...
            >
              ...
              <div>
                ...
                {/* Bullet Points */}
                <ul style={{ paddingTop: "32px", fontSize: "16px", color: "#333", fontWeight: 500, lineHeight: "1.875em", display: "flex", flexDirection: "column", gap: "12px", listStyle: "none" }}>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> Specialty and low-concentration RNA (evRNA, cfRNA)</li>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> Biospecimens and clinical samples (whole blood, plasma, serum, PBMC, tissues, FFPE)</li>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> {"Unusual organisms (plants, octopus, axolotl, ...)"}</li>
                  <li className="flex items-start gap-2"><img src="/images/arrow1.svg" alt="" className="mt-[21px] w-[5px] h-[5px] shrink-0" /> {"Degraded RNA (RIN number between 2 and 7)"}</li>
                </ul>
              </div>
