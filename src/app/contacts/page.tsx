...
export default function ContactsPage() {
  return (
    <div id="contacts-top" style={{ overflowX: "hidden" }}>
      ...
      {/* ── Main Content: Two-column layout with centered map ── */}
      <section
      ...
      >
        {/* Map background - centered across both columns */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
        ...
        <div style={{ flex: 1, position: "relative", zIndex: 1 }}>
          ...
          >
            Speak with our experts to tailor solutions to your specific research
            needs.
          </p>
          ...
          >
            ...
            <h2
              style={{
                ...
                background:
                  "linear-gradient(135deg, rgb(69, 208, 189), rgb(68, 182, 233))",
                backgroundClip: "text",
